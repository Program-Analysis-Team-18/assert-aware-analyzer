...
"""
This is the copy of the original fuzzer.
The new one has changes that should make the program work faster - but because of those alterations, the new version may not be a proper 'fuzzer'.
Hence, it is better to keep this file as a copy, in case we needed it.
"""
